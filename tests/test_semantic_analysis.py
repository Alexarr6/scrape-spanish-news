...
POINTS = [
    PointArtifact(article_id=1, source='elpais', title='A', url='https://e/1', published_at='', x=0.0, y=0.0, z=0.0),
    PointArtifact(article_id=2, source='elmundo', title='B', url='https://e/2', published_at='', x=0.12, y=0.08, z=0.01),
    PointArtifact(article_id=3, source='abc', title='C', url='https://e/3', published_at='', x=0.18, y=-0.04, z=-0.02),
    PointArtifact(article_id=4, source='elpais', title='D', url='https://e/4', published_at='', x=5.0, y=5.0, z=5.1),
    PointArtifact(article_id=5, source='eldiario', title='E', url='https://e/5', published_at='', x=5.1, y=5.0, z=5.0),
    PointArtifact(article_id=6, source='abc', title='F', url='https://e/6', published_at='', x=5.05, y=5.15, z=4.95),
    PointArtifact(article_id=7, source='lavanguardia', title='G', url='https://e/7', published_at='', x=11.0, y=11.0, z=11.0),
]
...
def test_analyze_points_detects_clusters_and_outlier_from_embeddings() -> None:
    ...
    assert analysis.metadata.distance_basis == 'normalized_embedding_euclidean'
    assert analysis.metadata.config['algorithm'] == 'hdbscan'


def test_analyze_points_ignores_misleading_projection_layout() -> None:
    misleading_points = [
        PointArtifact(article_id=1, source='elpais', title='A', url='https://e/1', published_at='', x=0.0, y=0.0, z=0.0),
        PointArtifact(article_id=2, source='elmundo', title='B', url='https://e/2', published_at='', x=10.0, y=10.0, z=10.0),
        PointArtifact(article_id=3, source='abc', title='C', url='https://e/3', published_at='', x=20.0, y=20.0, z=20.0),
        PointArtifact(article_id=4, source='elpais', title='D', url='https://e/4', published_at='', x=0.1, y=0.1, z=0.1),
        PointArtifact(article_id=5, source='eldiario', title='E', url='https://e/5', published_at='', x=10.1, y=10.1, z=10.1),
        PointArtifact(article_id=6, source='abc', title='F', url='https://e/6', published_at='', x=20.1, y=20.1, z=20.1),
    ]
...
def test_analyze_points_handles_single_point_as_outlier() -> None:
    analysis = analyze_points(POINTS[:1], EMBEDDINGS[:1])
