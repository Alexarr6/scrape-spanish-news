...
from src.analysis.story_candidates import StoryCandidateGenerator
from src.analysis.story_closure import StoryClosureBuilder
...
class ClusterPipeline:
    ...
    def _load_semantic_neighbor_candidates(
        ...
        *,
        ...
        return self._candidate_generator.load_semantic_neighbor_candidates(
            articles,
            max_days_delta=max_days_delta,
            limit=limit,
        )
    ...
    def _preserve_medium_components(
        ...
        *,
        ...
        self._story_closure_builder().preserve_medium_components(
    ...
    def _merge_supported_components(
        ...
        *,
        ...
        self._story_closure_builder().merge_supported_components(
            components=components,
            member_meta=member_meta,
            strong_adjacency=strong_adjacency,
    ...
    def _should_merge_components(
        ...
        return self._story_closure_builder().should_merge_components(
            left_cluster,
            right_cluster,
            support,
        )
    ...
    def _audit_medium_component(
        ...
        *,
        ...
        return self._story_closure_builder().audit_medium_component(
    ...
    def _is_medium_component_edge_compatible(self, reason: StoryClusterMemberReason) -> bool:
        return self._story_closure_builder().is_medium_component_edge_compatible(reason)
    ...
    def _closure_attach_meta(
        ...
        *,
        ...
        return self._story_closure_builder().closure_attach_meta(
    ...
    def _should_attach_candidate(
        ...
        return self._story_closure_builder().should_attach_candidate(cluster, support)
